...
const char* >("generator_ack" , std::move(i_input_data_ack));
...
std::shared_ptr<cadmium::dynamic::modeling::model> sender1 = cadmium::
...
make_shared<cadmium::dynamic::modeling::coupled<TIME>>( "TOP", 
                                                        submodels_TOP, 
                                                        iports_TOP, 
                                                        oports_TOP, 
                                                        eics_TOP, 
